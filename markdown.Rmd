...
data_in <- read.spss('L_Corona_app_wave3_3p.sav', to.data.frame=TRUE, use.missings=FALSE)
...
data_wave_min1_in <- read.spss('L_Corona_app_wave2_3p.sav', to.data.frame=TRUE, use.missings=FALSE)
...
```{r trustgovernment, eval=FALSE, echo=FALSE, fig.width=7, fig.height=3, fig.cap="Vertrouwen in de Nederlandse overheid", tab.cap="Vertrouwen in de Nederlandse overheid. Als het gaat om de bestrijding van corona, dan..."}
